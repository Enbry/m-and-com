        ...
        <div className="posts-item" key={node.fields.slug}>
          <Link style={{ boxShadow: `none` }} to={`/posts${node.fields.slug}`}>
            ...
            <div className="posts-itemContent">
              ...
              <small className="posts-itemDate">
                <FontAwesomeIcon icon={faCalendarAlt} className="posts-itemDateIcon"/>
                {node.frontmatter.date}
                </small>
              <p
                className="posts-itemDesc"
                dangerouslySetInnerHTML={{
                  __html: node.excerpt,
                }}
              />
      ...
      <div className="posts-search">
        <SearchBar>
          ...
          <input
            ...
            onChange={e => {
              navigate(
                e.target.value ? `/posts/?search=${e.target.value}` : "/posts/"
              )
